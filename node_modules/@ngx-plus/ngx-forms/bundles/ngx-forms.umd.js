(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs/Subject'), require('rxjs/operator/debounceTime'), require('rxjs/operator/map')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs/Subject', 'rxjs/operator/debounceTime', 'rxjs/operator/map'], factory) :
	(factory((global['ngx-forms'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype));
}(this, (function (exports,core,common,forms,Subject,debounceTime,map) { 'use strict';
...
var NgxFormsService = (function () {
    function NgxFormsService() {
    }
    /**
     * @param {?} fields
     * @return {?}
     */
    NgxFormsService.prototype.parseFields = function (fields) {
        var _this = this;
        return Object.keys(fields).map(function (fieldName) {
            // Get the field definition and type
            var /** @type {?} */ fieldDef = fields[fieldName];
            var /** @type {?} */ fieldType = fieldDef['type'] || 'input';
            // If the field definition is a string then that serves as the type and will use the inputs default options
            return typeof fieldDef === 'string' ? _this[fieldDef](fieldName) : _this[fieldType](fieldName, fieldDef);
        });
    };
    /**
     * @param {?=} type
     ...
     * @return {?}
     */
    NgxFormsService.prototype.field = function (type, templateType, key, options) {
        if (type === void 0) { type = 'input'; }
        if (templateType === void 0) { templateType = 'text'; }
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
        var /** @type {?} */ fieldType = type !== 'input' ? type : templateType;
        ...
        var /** @type {?} */ templateOptions = {
            type: templateType,
        };
        // This are the keys that we need to put into formly's templateOptions
        var /** @type {?} */ toKeys = ['disabled', 'label', 'options', 'placeholder', 'toolbar'];
     ...
     * @return {?}
     */
    NgxFormsService.prototype.input = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
     ...
     * @return {?}
     */
    NgxFormsService.prototype.email = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
     ...
     * @return {?}
     */
    NgxFormsService.prototype.password = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
     ...
     * @return {?}
     */
    NgxFormsService.prototype.date = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
     ...
     * @return {?}
     */
    NgxFormsService.prototype.textarea = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
     ...
     * @return {?}
     */
    NgxFormsService.prototype.wysiwyg = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
     ...
     * @return {?}
     */
    NgxFormsService.prototype.select = function (key, options) {
        if (key === void 0) { key = null; }
        if (options === void 0) { options = {}; }
        return this.field('select', 'text', key, options);
    };
    return NgxFormsService;
}());
NgxFormsService.decorators = [
    { type: core.Injectable },
];
/**
 * @nocollapse
 */
NgxFormsService.ctorParameters = function () { return []; };
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var FormlyConfig = (function () {
    ...
    FormlyConfig.prototype.addConfig = function (config) {
        ...
        if (config.validationMessages) {
            config.validationMessages.map(function (validation) { return _this.addValidatorMessage(validation.name, validation.message); });
        }
        if (config.extras) {
    ...
    FormlyConfig.prototype.setType = function (options) {
        ...
        if (Array.isArray(options)) {
            options.map(function (option) { return _this.setType(option); });
        }
        else {
            ...
            if (options.wrappers) {
                options.wrappers.map(function (wrapper) { return _this.setTypeWrapper(options.name, wrapper); });
            }
        }
    };
    /**
...
var FormlyFormBuilder = (function () {
    ...
    FormlyFormBuilder.prototype.buildForm = function (form, fields, model, options) {
        ...
        if (!options.fieldChanges) {
            options.fieldChanges = new Subject.Subject();
        }
    ...
    FormlyFormBuilder.prototype.registerFormControls = function (form, fields, model, options) {
        ...
        fields.map(function (field, index) {
            ...
            if (field.key && field.type) {
                ...
                if (path.length > 1) {
                    var /** @type {?} */ rootPath = path.shift();
                    var /** @type {?} */ nestedForm = ((form.get(rootPath.toString()) ? form.get(rootPath.toString()) : new forms.FormGroup({})));
                    ...
                    var /** @type {?} */ originalKey = field.key;
                    ...
                    if (!isUndefined(field.defaultValue) && isUndefined(model[path[0]])) {
                        var /** @type {?} */ modelPath = getKeyPath({ key: _this.defaultPath });
            ...
            if (field.fieldGroup) {
                if (field.key) {
                    ...
                    var /** @type {?} */ nestedForm = (form.get(field.key)), /** @type {?} */ nestedModel = model[field.key] || {};
                    if (!nestedForm) {
                        nestedForm = new forms.FormGroup({}, field.validators ? field.validators.validation : undefined, field.asyncValidators ? field.asyncValidators.validation : undefined);
            ...
            if (field.fieldArray && field.key) {
                if (!(form.get(field.key) instanceof forms.FormArray)) {
                    var /** @type {?} */ arrayForm = new forms.FormArray([], field.validators ? field.validators.validation : undefined, field.asyncValidators ? field.asyncValidators.validation : undefined);
    ...
    FormlyFormBuilder.prototype.initFieldExpression = function (field, model, options) {
        ...
        if (field.expressionProperties) {
            for (var /** @type {?} */ key in field.expressionProperties) {
                ...
                var /** @type {?} */ expressionValue = evalExpression(field.expressionProperties[key].expression, { field: field }, [model, options.formState]);
    ...
    FormlyFormBuilder.prototype.addFormControl = function (form, field, model) {
        ...
        var /** @type {?} */ name = typeof field.key === 'string' ? field.key : field.key[0], /** @type {?} */ formControl;
        if (field.formControl instanceof forms.AbstractControl) {
            ...
            formControl = new forms.FormControl(model, field.validators ? field.validators.validation : undefined, field.asyncValidators ? field.asyncValidators.validation : undefined);
        }
    ...
    FormlyFormBuilder.prototype.addControl = function (form, key, formControl, field) {
        ...
        if (formControl instanceof forms.FormArray) {
...
var FormlyForm = (function () {
    ...
    FormlyForm.prototype.resetFormGroup = function (model, form, actualKey) {
        for (var /** @type {?} */ controlKey in form.controls) {
            var /** @type {?} */ key = getKey(controlKey, actualKey);
            if (form.controls[controlKey] instanceof forms.FormGroup) {
                this.resetFormGroup(model, /** @type {?} */ (form.controls[controlKey]), key);
            }
            if (form.controls[controlKey] instanceof forms.FormArray) {
                this.resetFormArray(model, /** @type {?} */ (form.controls[controlKey]), key);
            }
            if (form.controls[controlKey] instanceof forms.FormControl) {
    ...
    FormlyForm.prototype.resetFormArray = function (model, formArray, key) {
        var /** @type {?} */ newValue = getValueForKey(model, key);
        // removes and updates
        for (var /** @type {?} */ i = formArray.length - 1; i >= 0; i--) {
            if (formArray.at(i) instanceof forms.FormGroup) {
                if (newValue && !isNullOrUndefined(newValue[i])) {
                    this.resetFormGroup(newValue[i], /** @type {?} */ (formArray.at(i)));
                }
                else {
                    formArray.removeAt(i);
                    var /** @type {?} */ value = getValueForKey(this.model, key);
        ...
        if (Array.isArray(newValue) && formArray.length < newValue.length) {
            var /** @type {?} */ remaining = newValue.length - formArray.length;
            var /** @type {?} */ initialLength = formArray.length;
            for (var /** @type {?} */ i = 0; i < remaining; i++) {
                var /** @type {?} */ pos = initialLength + i;
    ...
    FormlyForm.prototype.updateInitialValue = function () {
        var /** @type {?} */ obj = reverseDeepMerge(this.form.value, this.model);
...
var FormlyField = (function () {
     ...
     */
    function FormlyField(elementRef, renderer, formlyConfig, componentFactoryResolver) {
    ...
    FormlyField.prototype.createFieldComponents = function () {
        ...
        if (this.field && !this.field.template && !this.field.fieldGroup && !this.field.fieldArray) {
            ...
            var /** @type {?} */ fieldComponentRef = this.createFieldComponent();
            if (this.field.key) {
                var /** @type {?} */ valueChanges_1 = fieldComponentRef.instance.formControl.valueChanges;
                if (debounce > 0) {
                ...
                this._subscriptions.push(valueChanges_1.subscribe(function (event) { return _this.modelChange.emit({ key: _this.field.key, value: event }); }));
            }
        }
    ...
    FormlyField.prototype.checkVisibilityChange = function () {
        if (this.field && this.field.hideExpression) {
            var /** @type {?} */ hideExpressionResult = !!evalExpression(this.field.hideExpression, this, [this.model, this.options.formState]);
    ...
    FormlyField.prototype.checkExpressionChange = function () {
        if (this.field && this.field.expressionProperties) {
            var /** @type {?} */ expressionProperties = this.field.expressionProperties;
            for (var /** @type {?} */ key in expressionProperties) {
                var /** @type {?} */ expressionValue = evalExpression(expressionProperties[key].expression, this, [this.model, this.options.formState]);
            ...
            var /** @type {?} */ formControl = this.field.formControl;
            if (formControl) {
    ...
    FormlyField.prototype.toggleHide = function (value) {
        ...
        if (this.options.fieldChanges) {
            this.options.fieldChanges.next(/** @type {?} */ ({ field: this.field, type: 'hidden', value: value }));
        }
    };
    ...
    Object.defineProperty(FormlyField.prototype, "fieldParentFormControl", {
         ...
         */
        get: function () {
            var /** @type {?} */ paths = this.field.key.split('.');
    ...
    FormlyField.prototype.addFieldControl = function () {
        var /** @type {?} */ parent = this.fieldParentFormControl;
    ...
    FormlyField.prototype.removeFieldControl = function () {
        var /** @type {?} */ parent = this.fieldParentFormControl;
        if (parent instanceof forms.FormArray) {
            parent.removeAt(/** @type {?} */ (this.fieldKey));
        }
        else if (parent instanceof forms.FormGroup) {
    ...
    FormlyAttributes.prototype.ngOnChanges = function (changes) {
        ...
        if (changes.field) {
            ...
            this.attributes
                ...
                .map(function (attr) { return _this.renderer.setAttribute(_this.elementRef.nativeElement, attr, _this.getPropValue(_this.field, attr)); });
            this.statements
...
var FORMLY_DIRECTIVES = [FormlyForm, FormlyField, FormlyAttributes, FormlyGroup, FormlyValidationMessage];
...
var FormlyFieldCheckbox = (function (_super) {
    __extends$1(FormlyFieldCheckbox, _super);
    ...
    FormlyFieldCheckbox.createControl = function (model, field) {
        return new forms.FormControl({ value: model ? 'on' : undefined, disabled: field.templateOptions.disabled }, field.validators ? field.validators.validation : undefined, field.asyncValidators ? field.asyncValidators.validation : undefined);
    };
...
var FormlyFieldMultiCheckbox = (function (_super) {
    __extends$1(FormlyFieldMultiCheckbox, _super);
...
var FormlyFieldInput = (function (_super) {
    __extends$1(FormlyFieldInput, _super);
...
var FormlyFieldRadio = (function (_super) {
    __extends$1(FormlyFieldRadio, _super);
...
var FormlyFieldTextArea = (function (_super) {
    __extends$1(FormlyFieldTextArea, _super);
...
var FormlyFieldSelect = (function (_super) {
    __extends$1(FormlyFieldSelect, _super);
...
var FormlyWrapperFieldset = (function (_super) {
    __extends$1(FormlyWrapperFieldset, _super);
...
var FormlyWrapperLabel = (function (_super) {
    __extends$1(FormlyWrapperLabel, _super);
...
var FormlyWrapperDescription = (function (_super) {
    __extends$1(FormlyWrapperDescription, _super);
...
var FormlyWrapperValidationMessages = (function (_super) {
    __extends$1(FormlyWrapperValidationMessages, _super);
...
var FormlyWrapperAddons = (function (_super) {
    __extends$1(FormlyWrapperAddons, _super);
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                function makeEmbedArrowHandler(key, shiftKey) {
                    ...
                    return _ref3 = {
                        ...
                        if (!(leaf instanceof _embed2.default))
                            return true;
...
var Quill = Object.freeze({
    default: quill$1,
    __moduleExports: quill
});
/* tslint:disable:no-forward-ref */
var NgxQuillEditorComponent = (function () {
    /**
     * @param {?} elementRef
     */
    function NgxQuillEditorComponent(elementRef) {
        this.elementRef = elementRef;
        this.emptyArray = [];
        this.defaultModules = {
            toolbar: [
     ...
     * @return {?}
     */
    NgxQuillEditorComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
     ...
     * @return {?}
     */
    NgxQuillEditorComponent.prototype.ngOnChanges = function (changes) {
     ...
     * @return {?}
     */
    NgxQuillEditorComponent.prototype.writeValue = function (currentValue) {
     ...
     * @return {?}
     */
    NgxQuillEditorComponent.prototype.registerOnChange = function (fn) {
     ...
     * @return {?}
     */
    NgxQuillEditorComponent.prototype.registerOnTouched = function (fn) {
        this.onModelTouched = fn;
    };
    /**
     * @return {?}
     */
    NgxQuillEditorComponent.prototype.validate = function () {
        if (!this.quillEditor) {
            return null;
        }
        var /** @type {?} */ valid = true;
    ...
    return NgxQuillEditorComponent;
}());
NgxQuillEditorComponent.decorators = [
    { type: core.Component, args: [{
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return NgxQuillEditorComponent; }),
                        multi: true,
                    },
                    {
 ...
 * @nocollapse
 */
NgxQuillEditorComponent.ctorParameters = function () { return [
    { type: core.ElementRef, },
]; };
NgxQuillEditorComponent.propDecorators = {
...
var FormlyFieldWysiwygComponent = (function (_super) {
    __extends(FormlyFieldWysiwygComponent, _super);
    function FormlyFieldWysiwygComponent() {
        ...
        _this.toolbar = _this.toolbars.basic;
        _this.theme = 'snow';
        return _this;
    }
    /**
     * @return {?}
     */
    FormlyFieldWysiwygComponent.prototype.ngOnInit = function () {
        this.toolbar = this.toolbars[this.to['toolbar']] || this.toolbars.default;
        this.theme = this.to['theme'] || this.theme;
    };
    return FormlyFieldWysiwygComponent;
}(FieldType));
FormlyFieldWysiwygComponent.decorators = [
    { type: core.Component, args: [{
 ...
 * @nocollapse
 */
FormlyFieldWysiwygComponent.ctorParameters = function () { return []; };
var formlyConfig = {
    types: [
        {
            name: 'wysiwyg',
...
var NgxFormlyModule = (function () {
    function NgxFormlyModule() {
    }
    return NgxFormlyModule;
}());
NgxFormlyModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [forms.FormsModule, forms.ReactiveFormsModule, FormlyModule.forRoot(formlyConfig), FormlyBootstrapModule, QuillModule],
 ...
 * @nocollapse
 */
NgxFormlyModule.ctorParameters = function () { return []; };
var NgxFormComponent = (function () {
    function NgxFormComponent() {
        this.form = new forms.FormGroup({});
        this.item = {};
     ...
     * @return {?}
     */
    NgxFormComponent.prototype.handleAction = function ($event) {
        this.action.emit($event);
    };
    return NgxFormComponent;
}());
NgxFormComponent.decorators = [
    { type: core.Component, args: [{
                selector: 'ngx-form',
 ...
 * @nocollapse
 */
NgxFormComponent.ctorParameters = function () { return []; };
NgxFormComponent.propDecorators = {
    'form': [{ type: core.Input },],
    'config': [{ type: core.Input },],
    'item': [{ type: core.Input },],
    'action': [{ type: core.Output },],
};
var NgxFormButtonsComponent = (function () {
    function NgxFormButtonsComponent() {
        this.buttons = [];
        this.item = {};
        this.classNames = 'btn btn-default';
        this.action = new core.EventEmitter();
    }
    /**
     * @param {?} type
     ...
     * @return {?}
     */
    NgxFormButtonsComponent.prototype.click = function (type, payload) {
        payload = payload || this.item;
        this.action.emit({ type: type, payload: Object.assign({}, payload) });
    };
    return NgxFormButtonsComponent;
}());
NgxFormButtonsComponent.decorators = [
    { type: core.Component, args: [{
 ...
 * @nocollapse
 */
NgxFormButtonsComponent.ctorParameters = function () { return []; };
NgxFormButtonsComponent.propDecorators = {
    'buttons': [{ type: core.Input },],
    'item': [{ type: core.Input },],
    'classNames': [{ type: core.Input },],
    'action': [{ type: core.Output },],
};
var NgxFormFieldsComponent = (function () {
    /**
     * @param {?} formsService
     */
    function NgxFormFieldsComponent(formsService) {
     ...
     * @return {?}
     */
    NgxFormFieldsComponent.prototype.ngOnChanges = function (change) {
        if (change['fields']) {
            this.formlyFields = this.formsService.parseFields(this.fields);
        }
    };
    return NgxFormFieldsComponent;
}());
NgxFormFieldsComponent.decorators = [
    { type: core.Component, args: [{
 ...
 * @nocollapse
 */
NgxFormFieldsComponent.ctorParameters = function () { return [
    { type: NgxFormsService, },
]; };
NgxFormFieldsComponent.propDecorators = {
    'form': [{ type: core.Input },],
    'formlyFields': [{ type: core.Input },],
    'fields': [{ type: core.Input },],
    'item': [{ type: core.Input },],
    'action': [{ type: core.Output },],
};
var NgxFormHeaderComponent = (function () {
    function NgxFormHeaderComponent() {
        this.item = {};
        this.title = null;
        this.icon = null;
    }
    return NgxFormHeaderComponent;
}());
NgxFormHeaderComponent.decorators = [
    { type: core.Component, args: [{
 ...
 * @nocollapse
 */
NgxFormHeaderComponent.ctorParameters = function () { return []; };
NgxFormHeaderComponent.propDecorators = {
    'item': [{ type: core.Input },],
    'title': [{ type: core.Input },],
    'icon': [{ type: core.Input },],
};
var NgxFormsModule = (function () {
    function NgxFormsModule() {
    }
    /**
     * @return {?}
     */
    NgxFormsModule.forRoot = function () {
        return {
            ngModule: NgxFormsModule,
            providers: [NgxFormsService],
        };
    };
    return NgxFormsModule;
}());
NgxFormsModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [common.CommonModule, forms.FormsModule, forms.ReactiveFormsModule, NgxFormlyModule],
                declarations: [NgxFormComponent, NgxFormButtonsComponent, NgxFormFieldsComponent, NgxFormHeaderComponent],
                exports: [NgxFormComponent, NgxFormButtonsComponent, NgxFormFieldsComponent, NgxFormHeaderComponent],
            },] },
];
/**
 * @nocollapse
 */
NgxFormsModule.ctorParameters = function () { return []; };

exports.NgxFormsModule = NgxFormsModule;
exports.NgxFormsService = NgxFormsService;
exports.NgxFormComponent = NgxFormComponent;
exports.NgxFormButtonsComponent = NgxFormButtonsComponent;
exports.NgxFormFieldsComponent = NgxFormFieldsComponent;
exports.NgxFormHeaderComponent = NgxFormHeaderComponent;
exports.ɵg = NgxFormButtonsComponent;
exports.ɵh = NgxFormFieldsComponent;
exports.ɵi = NgxFormHeaderComponent;
exports.ɵf = NgxFormComponent;
exports.ɵc = FormlyFieldWysiwygComponent;
exports.ɵb = formlyConfig;
exports.ɵa = NgxFormlyModule;
exports.ɵe = NgxQuillEditorComponent;
exports.ɵd = QuillModule;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-forms.umd.js.map

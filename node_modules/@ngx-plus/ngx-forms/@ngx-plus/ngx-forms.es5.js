...
import { ANALYZE_FOR_ENTRY_COMPONENTS, Component, ComponentFactoryResolver, Directive, ElementRef, EventEmitter, HostListener, Inject, Injectable, InjectionToken, Input, NgModule, Output, Renderer2, ViewChild, ViewContainerRef, ViewEncapsulation, forwardRef } from '@angular/core';
import { CommonModule } from '@angular/common';
import { AbstractControl, FormArray, FormControl, FormGroup, FormsModule, NG_VALIDATORS, NG_VALUE_ACCESSOR, ReactiveFormsModule, Validators } from '@angular/forms';
...
var FormlyFormBuilder = (function () {
    ...
    FormlyFormBuilder.prototype.buildForm = function (form, fields, model, options) {
        ...
        if (!options.fieldChanges) {
            options.fieldChanges = new Subject$1();
        }
        ...
        fields.map(function (field, index) {
            ...
            if (field.key && field.type) {
                ...
                if (path.length > 1) {
                    ...
                    var /** @type {?} */ nestedForm = ((form.get(rootPath.toString()) ? form.get(rootPath.toString()) : new FormGroup({})));
            ...
            if (field.fieldArray && field.key) {
                if (!(form.get(field.key) instanceof FormArray)) {
                    var /** @type {?} */ arrayForm = new FormArray([], field.validators ? field.validators.validation : undefined, field.asyncValidators ? field.asyncValidators.validation : undefined);
    ...
    FormlyFormBuilder.prototype.addFormControl = function (form, field, model) {
        ...
        if (field.formControl instanceof AbstractControl) {
            ...
            formControl = new FormControl(model, field.validators ? field.validators.validation : undefined, field.asyncValidators ? field.asyncValidators.validation : undefined);
        }
    ...
    FormlyField.prototype.createFieldComponents = function () {
        ...
        if (this.field && !this.field.template && !this.field.fieldGroup && !this.field.fieldArray) {
            ...
            if (this.field.key) {
                ...
                if (debounce > 0) {
                    valueChanges_1 = debounceTime$1.call(valueChanges_1, debounce);
                }
                if (this.field.parsers && this.field.parsers.length > 0) {
                    this.field.parsers.map(function (parserFn) {
                        valueChanges_1 = map$1.call(valueChanges_1, parserFn);
                    });
                }
                ...
                providers: [
                    {
                        ...
                        useExisting: forwardRef(function () { return NgxQuillEditorComponent; }),
                        multi: true,
                    },
                    {
...
NgxFormsModule.decorators = [
    { type: NgModule, args: [{
                imports: [CommonModule, FormsModule, ReactiveFormsModule, NgxFormlyModule],
 ...
 */
export { NgxFormsModule, NgxFormsService, NgxFormComponent, NgxFormButtonsComponent, NgxFormFieldsComponent, NgxFormHeaderComponent, NgxFormButtonsComponent as ɵg, NgxFormFieldsComponent as ɵh, NgxFormHeaderComponent as ɵi, NgxFormComponent as ɵf, FormlyFieldWysiwygComponent as ɵc, formlyConfig as ɵb, NgxFormlyModule as ɵa, NgxQuillEditorComponent as ɵe, QuillModule as ɵd };
//# sourceMappingURL=ngx-forms.es5.js.map

...
DatatablesColumnComponent.propDecorators = {
    ...
    'contentPadding': [{ type: core.Input },],
    'createdCell': [{ type: core.Input },],
    'data': [{ type: core.Input },],
    'defaultContent': [{ type: core.Input },],
    'name': [{ type: core.Input },],
    'orderable': [{ type: core.Input },],
    'orderData': [{ type: core.Input },],
    'orderDataType': [{ type: core.Input },],
    'orderFixed': [{ type: core.Input },],
    'orderSequence': [{ type: core.Input },],
...
var DatatablesComponent = (function (_super) {
    ...
    DatatablesComponent.prototype.ngAfterViewInit = function () {
        if (!this.columns || !this.columns.length) {
            this.tableElementRef = new core.ElementRef($(this.elementRef.nativeElement).find('table:first').get(0));
        }
...
exports.DatatablesColumnComponent = DatatablesColumnComponent;
exports.DatatablesTemplateComponent = DatatablesTemplateComponent;
exports.DatatablesPortletComponent = DatatablesPortletComponent;
exports.DatatablesTemplateDirective = DatatablesTemplateDirective;
exports.DatatablesComponent = DatatablesComponent;
exports.ɵa = Datatables;
exports.ɵb = DatatablesDirective;

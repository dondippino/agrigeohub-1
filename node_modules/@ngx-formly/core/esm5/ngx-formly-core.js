...
var FormlyFormBuilder = /** @class */ (function () {
    ...
    FormlyFormBuilder.prototype.addFormControl = function (form, field, model, path) {
        var control;
        var validators = field.validators ? field.validators.validation : undefined, asyncValidators = field.asyncValidators ? field.asyncValidators.validation : undefined;
